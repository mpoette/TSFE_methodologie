...
def create_pipeline_widgets():
    ...
    return {
        ...
        "use_optuna": mo.ui.dropdown(
            ...
            value="Oui",
            label="Use Optuna when available",
        ),
    }


# ============================================================================
# CONDITIONAL MODEL AND CALIBRATION WIDGETS
# ============================================================================
...
def get_calibration_widgets(
    ...
    if is_prior_forced:
        ...
        options_calib = {
            "Yes (required by resampling)": True,
        }

        bool_calib = "Yes (required by resampling)"
...
def render_sidebar(
    ...
    sidebar_items = [
        ...
        mo.md(
            f"<U>Seed used throughout the code : "
            f"**{seed}**</U>"
        ),
        mo.md(
    ...
    if uid["type_donnees"].value == "modèle":
        ...
        sidebar_items.extend(
            [
                ...
                mo.md(
                    f"**Retained features :** `{keep_feats}`"
                ),
                mo.md(
                    "**French description: "
